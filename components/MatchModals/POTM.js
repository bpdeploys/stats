 ...
 * @param {boolean} props.active - Indicates if the component is active
 * @param {Object} props.match - Match data
 * @param {number} props.match.id - ID of the match
 * @param {Array} props.match.playingteam1 - Players of team 1
 * @param {Array} props.match.playingteam2 - Players of team 2
 * @param {Array} props.match.substeam1 - Substitutes of team 1
 * @param {Array} props.match.substeam2 - Substitutes of team 2
 * @param {Object} props.match.team1 - Data of team 1
 * @param {Object} props.match.team2 - Data of team 2
 */
